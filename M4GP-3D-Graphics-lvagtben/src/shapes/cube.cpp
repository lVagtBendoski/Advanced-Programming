...
void Cube::initVectors() {
    ...
    this->vertices.insert(this->vertices.end(), {
            // Front face:
             0.5f,  0.5f,  0.5f, colors[2].red, colors[2].green, colors[2].blue, // Top right
            -0.5f,  0.5f,  0.5f, colors[3].red, colors[3].green, colors[3].blue, // Top left
             0.5f, -0.5f,  0.5f, colors[1].red, colors[1].green, colors[1].blue, // Bottom right
            -0.5f, -0.5f,  0.5f, colors[0].red, colors[0].green, colors[0].blue, // Bottom left
